...
```go
import "github.com/umats/gomarkdoc/cmd/gomarkdoc"
```

Package gomarkdoc provides a command line interface for writing golang documentation in markdown format.

See https://github.com/umats/gomarkdoc for full documentation of this tool.
...
## type [PackageSpec](<https://github.com/umats/gomarkdoc/blob/master/cmd/gomarkdoc/command.go#L30-L44>)
